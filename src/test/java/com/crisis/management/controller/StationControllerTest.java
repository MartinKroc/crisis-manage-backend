...
public class StationControllerTest {
    ...
    @Test
    void should_get_water_stations() throws Exception {

        mockMvc.perform(get("/api/station/water")
    ...
    @Test
    void should_get_weather_stations() throws Exception {

        mockMvc.perform(get("/api/station/weather")
                .header("authorization", addUser.getBearerToken()))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    @Test
    void should_get_water_station_by_id() throws Exception {

        mockMvc.perform(get("/api/station/water/1")
                .header("authorization", addUser.getBearerToken()))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    @Test
    void should_get_weather_station_by_id() throws Exception {

        mockMvc.perform(get("/api/station/weather/1")
                .header("authorization", addUser.getBearerToken()))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    void should_get_error_status_404() throws Exception {
        this.mockMvc.perform(get("/api/v1/station/water/{id}", 222)).andDo(print()).andExpect(status().is(404));
    }
